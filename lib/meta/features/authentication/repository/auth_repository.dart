...
class AuthRepo {
  ...
  // Failure --> String : Success --> UserModel
  FutureEither<UserModel> signInWithGoogle(bool isFromLogin) async {
    try {
      ...
      if (userCredential.additionalUserInfo!.isNewUser) {
        userModel = UserModel(
          ...
          profileBanner: Constants.bannerDefault,
    ...
    // if error detected --> throw it to next catch block
  ...
  FutureEither<UserModel> signInAsGuest() async {
    try {
      ...
      UserModel userModel = UserModel(
        name: 'Guest',
        profileAvatar: Constants.avatarDefault,
        profileBanner: Constants.bannerDefault,
        uid: userCredential.user!.uid,
        isGuest: true,
        karma: 0,
